...
public class GlobalModelAttributes {
    ...
    @ModelAttribute
    public void addBusinessAttributes(Model model, Authentication authentication) {
        ...
        addDashboardWidgetAttributes(model, authentication);
    ...
    private void addDashboardWidgetAttributes(Model model, Authentication authentication) {
