...
backup_file="$ROOT_DIR/runtime-data/matrix26-control/maintenance/application.properties.phase3i1.bak"
...
echo "Matrix26 Operations Phase 3I.1 configuration checked."
