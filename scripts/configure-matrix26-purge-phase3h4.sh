...
BACKUP_FILE="$MAINTENANCE_DIR/application.properties.phase3h4.bak"
...
echo "Matrix26 Purge Manager Phase 3H.4 archive destruction executor configuration updated."
echo "Execution remains disabled by default. Enable it manually only during the controlled destruction test."
