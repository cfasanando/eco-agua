...
@Entity
@Table(name = "matrix26_instance_appearance_draft")
public class Matrix26InstanceAppearanceDraft {
    ...
    @Column(name = "overrides_json", nullable = false, columnDefinition = "TEXT")
